      ...
      <div className=' bg-slate-950  text-white'>
        <div className='px-6 py-2 flex justify-between items-center font-bold text-sm'>
          <div className='flex gap-2.5'>
            ...
            <span className='flex gap-1.5 p-2.5'>
              <img src='public/images/email-icon.svg' alt='' />
          ...
          <div className='flex items-center gap-2.5'>
            ...
            <span className='flex gap-1'>
              <img className='p-1' src='public/images/instagram-icon.svg' alt='' />
              <img className='p-1' src='public/images/youtube-icon.svg' alt='' />
              <img className='p-1' src='public/images/facebook-icon.svg' alt='' />
              <img className='p-1' src='public/images/twitter-icon.png' alt='' />
            </span>
          </div>
        </div>
      </div>
